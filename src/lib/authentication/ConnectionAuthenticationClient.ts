...
/**
 * @class SamlAuthenticationClient 社会化登录模块
 ...
 *    appId: "YOUR_APP_ID",
 * })
 * await authenticationClient.connections.authorize("github", {
 ...
 *
 *
 * @name SamlAuthenticationClient
 */
export class SamlAuthenticationClient {
   ...
   * })
   *
   * @memberof ConnectionAuthenticationClient
   */
  async authorize(
    provider: string,
    options?: {
