...
export const PoliciesDocument = `
    query policies($page: Int, $limit: Int, $excludeDefault: Boolean, $namespace: String) {
  policies(page: $page, limit: $limit, excludeDefault: $excludeDefault, namespace: $namespace) {
    totalCount
    list {
      namespace
      code
